...
<template>
    <!-- post card -->
    <div v-for="poster in feed">
        <div
            v-for="post in poster.posts"
        ...
        >
            ...
            <div class="flex items-start px-4 py-6">
                <img
                    ...
                    v-bind:src="poster.postUser.avatar"
                    alt="avatar"
                />
                <div class="w-full">
                    <div class="flex items-center justify-between">
                        ...
                        >{{ poster.postUser.firstname + ' ' + poster.postUser.lastname }}</h2>
                        <small class="text-sm text-t-accent">{{ fromNow(post.createdAt) }}</small>
                    </div>
                    <p
                        class="text-t-accent text-xs"
                    >Joined {{ formatDate(poster.postUser.createdAt) }}.</p>
